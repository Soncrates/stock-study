...
class YahooParse(object) :
    ...
    def get_stock_daily(stock,year,strict=True) :
        ...
        return ret
    class StockDailyService(object) :
      def __init__(self,service=YahooParse.get_stock_daily,strict=True) :
    ...
    class StockDailyCache(object) :
      from functools import lru_cache
      def __init__(self,service = YahooParse.StockDailyService()) :
        self.fresh = {}
        self.cache = {}
        self.service = service
      @lru_cache(maxsize=100)
    ...
    class StockDaily(object) :
      def __init__(self, service = ConcurrentActor(YahooParse.StockDailyCache())) :
        self.service = service
      def __call__(self,stock) :
        return self.service(stock)
